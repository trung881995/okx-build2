...
var ASM_CONSTS = {
  2992672: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 2992733: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 2992797: function() {return Module.webglContextAttributes.powerPreference;},  
 2992855: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 2992910: function($0) {performance.now = function() { return $0; };},  
 2992958: function($0) {performance.now = function() { return $0; };},  
 2993006: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  async function _connectOKXWallet() {
          try {
              ...
              const session = await window.okxUniversalConnectUI.openModal({
                  namespaces: {
              ...
              if (session) {
                  console.log("Wallet connected:", session.accounts);
                  // Gửi địa chỉ ví về Unity
                  const walletAddress = session.accounts[0];
                  unityInstance.SendMessage('OKXManager', 'OnWalletConnected', walletAddress);
              }
          } catch (error) {
  ...
  async function _initializeOKXWallet() {
          try {
              window.okxUniversalConnectUI = await OKXUniversalConnectUI.init({
                  dappMetaData: {
                      icon: 'https://your-app-icon-url.png', // URL của icon
                      name: 'Your DApp Name'                // Tên ứng dụng của bạn
                  },
...
var asmLibraryArg = {
  ...
  "initializeOKXWallet": _initializeOKXWallet,
