...
var ASM_CONSTS = {
  2992720: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 2992781: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 2992845: function() {return Module.webglContextAttributes.powerPreference;},  
 2992903: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 2992958: function($0) {performance.now = function() { return $0; };},  
 2993006: function($0) {performance.now = function() { return $0; };},  
 2993054: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  if (!window.okxTonConnectUI) {
              ...
              const session = await window.okxTonConnectUI.openModal();
              ...
              if(session)
              {
                  ...
                  unityInstance.SendMessage('OKXManager', 'OnGetCurrentWallet', currentWallet);
                  unityInstance.SendMessage('OKXManager', 'OnGetCurrentAccount', currentAccount);
                  unityInstance.SendMessage('OKXManager', 'OnCheckWalletConnected', isConnected);
              }
